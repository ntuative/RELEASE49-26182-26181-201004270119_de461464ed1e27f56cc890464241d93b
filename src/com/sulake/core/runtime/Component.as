package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_808:uint = 4;
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_187.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            var_954 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_954);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1112 & const_808)
         {
            if(_loc3_ == 0)
            {
               if(var_187.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_187.getStructByIndex(_loc8_);
