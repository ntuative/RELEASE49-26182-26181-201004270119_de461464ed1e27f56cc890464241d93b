package com.sulake.core.runtime
{
   ...
   public final class CoreComponent extends ComponentContext implements ICore
   {
      ...
      private static const const_1127:String = "zip-libraries";
      
      private static const const_1130:String = "library";
      
      private static const const_1129:String = "library";
      
      private static const const_1126:String = "asset-libraries";
      ...
      private var var_321:uint;
      
      private var var_1102:IEventDispatcher;
      
      private var var_923:Profiler;
      ...
      public function CoreComponent(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_1192:
               ...
               var_923 = new Profiler(this);
               attachComponent(var_923,[new IIDProfiler()]);
               var_763 = new ProfilerViewer();
               var_214.addChild(var_763);
               break;
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(var_1102)
         {
            ...
            var_1102.dispatchEvent(new ProgressEvent(ProgressEvent.PROGRESS,false,false,param1.bytesLoaded,param1.bytesTotal));
         }
      }
      
      public function getNumberOfFilesLoaded() : uint
      {
         return var_321 - getNumberOfFilesPending();
      }
         ...
         while(criticality < CoreComponent.const_138)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     var_923.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(var_1102)
         {
            var_1102.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            while(_loc3_ < CoreComponent.const_138)
            {
               _loc2_ = var_542[_loc3_] as Array;
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1255);
         if(!_isDisposed)
         {
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = var_542[param2] as Array;
         _loc3_.push(param1);
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         while(_loc4_ < CoreComponent.const_138)
         {
            _loc3_ = var_542[_loc4_] as Array;
