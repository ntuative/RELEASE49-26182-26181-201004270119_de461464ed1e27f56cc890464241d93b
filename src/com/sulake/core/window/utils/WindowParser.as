package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1483:String = "_INCLUDE";
      
      public static const const_839:String = "_EXCLUDE";
      
      public static const const_1547:String = "_TEMP";
      
      private static const const_1107:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1108:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1118:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_955:Dictionary;
      
      protected var var_1397:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1117,var_1118);
         var_955 = new Dictionary();
         var_1398 = new Dictionary();
         ParamCodeTable.fillTables(var_955,var_1398);
         var_1397 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1108,"");
         return param1.replace(const_1107,"");
      }
      
      private function parseProperties(param1:XML) : Array
      {
         return param1 != null ? XMLPropertyArrayParser.method_1(param1.children()) : new Array();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1118)
            {
               delete var_1118[_loc1_];
            }
            for(_loc1_ in var_955)
            {
               delete var_955[_loc1_];
            }
            for(_loc1_ in var_1398)
            {
               delete var_1398[_loc1_];
            }
            var_1397.dispose();
            var_1397 = null;
            var_16 = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_839) == -1)
                  {
