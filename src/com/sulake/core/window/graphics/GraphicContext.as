package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_885:uint = 256;
      
      protected static var var_647:uint = 0;
      
      protected static var var_384:uint = 0;
      
      public static const const_828:uint = 2;
      
      public static const const_1489:uint = 128;
      
      public static const const_1520:uint = 64;
      
      public static const const_635:uint = 4;
      
      public static const const_1171:uint = 0;
      
      public static const const_1347:uint = 16;
      
      public static const const_720:uint = 1;
      
      public static const const_1263:uint = 8;
      ...
      protected var var_1613:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_885:
               break;
            case GraphicContext.const_1171:
               break;
            default:
         ...
         if(var_640)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1613,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1613,16777215);
                  }
                  var_384 += bitmap.width * bitmap.height * 4;
               }
