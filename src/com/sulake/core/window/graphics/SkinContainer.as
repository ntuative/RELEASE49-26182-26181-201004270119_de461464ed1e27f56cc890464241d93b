package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_794:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_2222 = new Dictionary();
         TypeCodeTable.fillTables(var_1595,var_2222);
         var_1364 = new Dictionary();
         var_2221 = new Dictionary();
         StateCodeTable.fillTables(var_1364,var_2221);
         var_540 = new Dictionary();
         var_540["skin"] = BitmapSkinRenderer;
         var_540["bitmap"] = BitmapDataRenderer;
         var_540["fill"] = FillSkinRenderer;
         var_540["text"] = TextSkinRenderer;
         var_540["shape"] = ShapeSkinRenderer;
         var_540["unknown"] = SkinRenderer;
         var_540["null"] = NullSkinRenderer;
         if(var_385 == null)
         {
            var_385 = new Array();
            var_385.push(WindowState.const_68);
            var_385.push(WindowState.const_73);
            var_385.push(WindowState.const_101);
            var_385.push(WindowState.WINDOW_STATE_SELECTED);
            var_385.push(WindowState.const_84);
            var_385.push(WindowState.const_77);
            var_385.push(WindowState.const_99);
            var_385.push(WindowState.const_92);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1364)
         {
            _loc3_.push(var_1364[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1595[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_761[param1] = new Array(SkinContainer.const_794);
         }
         var_761[param1][param2] = param3;
         if(true)
         {
            var_762[param1] = new Array(SkinContainer.const_794);
         }
         var_762[param1][param2] = param4;
      }
