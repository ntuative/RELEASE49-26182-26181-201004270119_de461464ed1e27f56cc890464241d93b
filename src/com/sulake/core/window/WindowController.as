package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc2_:* = !testParamFlag(WindowParam.const_136,WindowParam.const_153);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_8.clone();
            if(_loc1_)
      ...
      {
         var_553 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2219 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_561:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_221:
               _loc2_ = "null";
               break;
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_17)
         {
            var_17 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_720,var_8);
            var_17.visible = var_352;
         }
         return var_17;
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_894);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1099 || _loc3_.hasGraphicsContext())
         {
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_553);
      }
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_167:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_480,this,null));
                     if(testParamFlag(WindowParam.const_178,WindowParam.const_149))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_184,WindowParam.const_153))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_9 != null)
                     {
                        ...
                        _param = _loc8_;
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_263,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_431:
                  var_16.invalidate(this,var_8.union(var_56),WindowRedrawFlag.const_402);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1024,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_260,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_345:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_561,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_221,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_436:
               ...
               case WindowNotifyEvent.const_456:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_16.invalidate(this,var_8,WindowRedrawFlag.const_402);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_221:
                  ...
                  break;
               case WindowNotifyEvent.const_480:
                  var_9.getRegionProperties(null,var_319);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_329:
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_553);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_661,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_608;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1099 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            _loc7_ = uint(_param & 0);
            if(_loc7_ == WindowParam.const_374)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_971,this,null,true);
               update(this,_loc10_);
      ...
      public function lock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_68,true);
         _loc1_.type = WindowNotifyEvent.const_1259;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_166 && var_553 > 0)
         {
            if(!testParamFlag(WindowParam.const_35))
            {
               if(param1.x <= var_8.width && param1.y <= var_8.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1593,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1593,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1251,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_9 != param1)
         {
            ...
            else
            {
               ...
               var_319.width = 0;
               var_319.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_898,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_80,_param,var_16,var_8,null,var_646,properties,var_644.concat(),_id) as WindowController;
         _loc2_.var_553 = var_553;
         _loc2_.var_166 = var_166;
         _loc2_.var_1400 = var_1400;
         _loc2_.var_319 = var_319.clone();
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_470;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_33 == WindowState.const_388)
         {
            return true;
         }
         var_33 = WindowState.const_388;
         ...
         _loc1_.type = WindowNotifyEvent.const_881;
         update(this,_loc1_);
         dispose();
         return true;
      }
