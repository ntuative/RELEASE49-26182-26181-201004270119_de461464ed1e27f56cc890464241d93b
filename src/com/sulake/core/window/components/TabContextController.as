package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_1618:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1618 == null)
         {
            var_1618 = findChildByTag(TabContextController.const_1093) as IWindowContainer;
         }
         return var_1618;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_953 == null)
         {
            var_953 = findChildByTag(TabContextController.const_1092) as ITabSelectorWindow;
            if(var_953 != null)
            {
      ...
      {
         return !!var_822 ? selector.iterator : null;
      }
