package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1054:String = "increment";
      
      private static const const_492:String = "slider_bar";
      
      private static const const_1055:String = "decrement";
      ...
      protected var var_774:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_166 = false;
         var_21 = param12;
         _horizontal = param2 == WindowType.const_433;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_492:
      ...
      {
         return track.findChildByName(ScrollbarController.const_492) as WindowController;
      }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_821 != null)
         {
            ...
            {
               _loc1_ = IWindowContainer(var_9).findChildByName(var_821) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1054)
            {
               if(var_21)
               {
                  var_571 = true;
            ...
            else if(param2.name == ScrollbarController.const_1055)
            {
               if(var_21)
               {
                  var_571 = true;
            ...
            else if(param2.name == ScrollbarController.const_765)
            {
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_492).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_807)
         {
