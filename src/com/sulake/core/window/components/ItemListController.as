package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1035:String = "resize_on_item_update";
      
      protected static const const_1034:String = "spacing";
      
      protected static const const_1410:Boolean = false;
      ...
      protected static const const_1033:String = "auto_arrange_items";
      ...
      protected var var_2356:Number = 0;
      
      protected var var_550:Boolean = false;
      
      protected var var_2357:Number = 0;
      
      protected var var_549:Number;
      
      protected var var_1116:Boolean = false;
      
      protected var var_551:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_90 = 0;
         var_69 = 0;
         _horizontal = param2 == WindowType.const_306;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_166 = var_645 || !testParamFlag(WindowParam.const_35);
         _container = var_16.create("_CONTAINER","",WindowType.const_331,WindowStyle.const_295,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
      ...
      {
         return new Rectangle(var_549 * maxScrollH,var_551 * maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1034,_spacing,PropertyStruct.const_67,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1033,var_776,PropertyStruct.const_63,var_776 != const_1409));
         _loc1_.push(new PropertyStruct(const_1032,var_550,PropertyStruct.const_63,var_550 != const_1410));
         _loc1_.push(new PropertyStruct(const_1035,var_1116,PropertyStruct.const_63,var_1116 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_551 = param1;
            _container.y = -var_551 * maxScrollV;
            var_16.invalidate(_container,visibleRegion,WindowRedrawFlag.const_76);
         }
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1035:
                  ...
                  break;
               case const_1033:
                  var_776 = _loc2_.value as Boolean;
                  break;
            }
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_412,param1);
            }
            else
            {
