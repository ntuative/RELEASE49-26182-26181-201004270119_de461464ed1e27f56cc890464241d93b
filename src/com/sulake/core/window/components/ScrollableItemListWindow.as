package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_780:IItemListWindow;
      
      private var var_335:IScrollbarWindow;
      
      private var var_1404:Boolean = true;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_scrollBar.testStateFlag(WindowState.const_73))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_335)
         {
            ...
            if(var_335)
            {
               var_335.addEventListener(WindowEvent.const_275,scrollBarEventProc);
               var_335.addEventListener(WindowEvent.const_213,scrollBarEventProc);
            }
         }
         return var_335;
      }
      ...
      override public function dispose() : void
      {
         if(var_335)
         {
            var_335.removeEventListener(WindowEvent.const_275,scrollBarEventProc);
            var_335.removeEventListener(WindowEvent.const_213,scrollBarEventProc);
            var_335 = null;
         }
         if(var_780)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_780)
         {
            var_780 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_780;
      }
