package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_799:String = "margin_top";
      
      private static const const_1135:String = "_HEADER";
      
      private static const const_797:String = "margin_right";
      
      private static const const_1134:String = "_SCALER";
      
      private static const const_1105:String = "_TITLE";
      
      private static const const_1136:String = "_CONTENT";
      
      private static const const_796:String = "margin_left";
      
      private static const const_798:String = "margin_bottom";
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_796,_loc3_.left,PropertyStruct.const_67,_loc2_));
         _loc1_.push(new PropertyStruct(const_799,_loc3_.top,PropertyStruct.const_67,_loc2_));
         _loc1_.push(new PropertyStruct(const_797,0 - _loc3_.right,PropertyStruct.const_67,_loc2_));
         _loc1_.push(new PropertyStruct(const_798,0 - _loc3_.bottom,PropertyStruct.const_67,_loc2_));
         return _loc1_;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1372 == null)
         {
            var_1372 = findChildByTag(const_1135) as IHeaderWindow;
            if(!var_1372)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1105) as ITextWindow;
            if(!_title)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_239,false);
         }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1136) as IWindowContainer;
            if(!var_20)
            {
