package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1030:String = "tool_tip_caption";
      
      protected static const const_1407:uint = 500;
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_458 = new Array();
         var_458[0] = MouseCursorType.const_334;
         var_458[1] = MouseCursorType.const_43;
         var_458[2] = MouseCursorType.const_334;
         var_458[3] = MouseCursorType.const_334;
         var_458[4] = MouseCursorType.const_43;
         var_458[5] = MouseCursorType.const_43;
         var_458[6] = MouseCursorType.const_334;
         if(var_333 == null)
         {
            var_333 = new Array();
            var_333[0] = WindowState.const_99;
            var_333[1] = WindowState.const_77;
            var_333[2] = WindowState.const_84;
            var_333[3] = WindowState.const_68;
            var_333[4] = WindowState.WINDOW_STATE_SELECTED;
            var_333[5] = WindowState.const_101;
            var_333[6] = WindowState.const_73;
         }
      ...
      {
         param2.push(new PropertyStruct(const_1030,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_746));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_849,param1.toolTipDelay != const_1407));
         return param2;
      }
      ...
      {
         var_958 = param1 == null ? const_746 : param1;
      }
