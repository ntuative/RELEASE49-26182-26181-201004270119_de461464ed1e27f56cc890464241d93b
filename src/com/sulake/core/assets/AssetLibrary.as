package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_856:String = "AssetLibraryReady";
      
      public static const const_1188:String = "AssetLibraryUnloaded";
      
      public static const const_362:String = "AssetLibraryLoaded";
      
      public static const const_1376:String = "AssetLibraryLoadError";
      ...
      private var var_514:Boolean = true;
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_515 = _loc2_.manifest.copy();
         var_371 = _loc2_.resource;
         if(var_514)
         {
            AssetLibrary.fetchLibraryContents(this,var_515,var_371);
         }
         var_309 = true;
         dispatchEvent(new Event(AssetLibrary.const_362));
         dispatchEvent(new Event(AssetLibrary.const_856));
         if(var_514)
         {
            var_15.dispose();
            var_15 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_868,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_911,assetLoadEventHandler);
      ...
      {
         return param1 < var_370.length ? getAssetByName(var_370[param1]) : null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_515.child("library");
         if(_loc2_ == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_370.splice(var_370.indexOf(_loc2_),1);
