package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      private var var_815:IEncryption;
      
      private var var_677:int;
      
      private var var_346:ByteArray;
      ...
      private var var_345:IConnectionStateListener;
      
      private var var_569:IProtocol;
      
      private var var_816:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_308 = param2;
         var_346 = new ByteArray();
         var_816 = new MessageClassManager();
         var_77 = new Socket();
         var_347 = new Timer(const_1254,1);
         var_347.addEventListener(TimerEvent.TIMER,onTimeOutTimer);
      ...
      {
         var_347.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_677));
      ...
      {
         var_347.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_677));
      ...
      private function onConnect(param1:Event) : void
      {
         var_347.stop();
         var_1183 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_677));
         dispatchEvent(param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_816.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         var _loc5_:ByteArray = var_569.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_345)
         {
            var_345.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(var_815 != null)
         {
            _loc3_ = var_815.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(var_345)
         {
            var_345.connectionInit(param1,param2);
         }
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_346.writeByte(var_77.readUnsignedByte());
         }
      }
      ...
      {
         var_816.registerMessages(param1);
      }
      ...
      {
         var_347.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_677));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_569.getMessages(var_346,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            if(var_345)
            {
               var_345.messageReceived(String(_loc5_),_loc6_.toString());
            }
            _loc7_ = var_816.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
            for each(_loc9_ in _loc7_)
            {
               _loc13_ = var_308.getMessageEvents(this,_loc9_);
            ...
            for each(_loc12_ in _loc8_)
            {
               ...
               if(_loc14_ != null)
               {
                  ...
                  if(_loc14_ != _loc11_)
                  {
                     ...
                     _loc10_ = var_308.getMessageParser(_loc14_);
                     if(_loc10_.flush())
                     {
                        if(_loc10_.method_1(_loc17_))
                        {
                           _loc11_ = _loc14_;
                           _loc15_ = true;
                        }
         ...
         else if(_loc2_ > 0)
         {
            ...
            _loc18_.writeBytes(var_346,_loc2_);
            var_346 = _loc18_;
         }
      }
      ...
      {
         var_347.delay = param1;
      }
      
      private function onIOError(param1:IOErrorEvent) : void
      {
         var_347.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_677));
         switch(param1.type)
         {
      ...
      private function onClose(param1:Event) : void
      {
         var_347.stop();
         var_1183 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_677));
         dispatchEvent(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_815 + "\n");
      }
   }
}
