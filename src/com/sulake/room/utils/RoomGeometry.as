package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_740:Number = 64;
      ...
      private var var_1555:Number = 1;
      
      private var var_79:int = 0;
      
      private var var_442:Map = null;
      
      private var var_1077:Vector3d;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_83 = new Vector3d();
         var_1077 = new Vector3d();
         var_1555 = 1;
         var_1556 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1554 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_441 != param1 * var_1554)
         {
            var_441 = param1 * var_1554;
            ++var_79;
         }
      }
      ...
      {
         if(var_443 != param1 * var_1555)
         {
            var_443 = param1 * var_1555;
            ++var_79;
         }
      }
      ...
      {
         if(var_444 != param1 * var_1556)
         {
            var_444 = param1 * var_1556;
            ++var_79;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_442 != null)
         {
            ...
            var_442.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_442.add(_loc3_,_loc4_);
            ++var_79;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1077.assign(_loc22_);
         }
         else
         {
            var_1077.assign(_loc17_);
         }
         ++var_79;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_444;
         _loc2_.z *= var_441;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1077);
         if(_loc3_ < var_2370 || _loc3_ > var_2369)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_444;
            _loc2_.z *= var_441;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1077);
         }
      ...
      {
         return new Vector3d(0 * var_443,0 * var_444,0 * var_441);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_442 != null)
         {
            ...
            return var_442.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_443,0 * var_444,0 * var_441);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_83;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_443,param2.y * var_444,param2.z * var_441);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_443,param3.y * var_444,param3.z * var_441);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_443,param4.y * var_444,param4.z * var_441);
