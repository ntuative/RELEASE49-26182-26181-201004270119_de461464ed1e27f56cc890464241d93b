package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_770:uint = 11;
      ...
      private var var_157:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_1002:int = -1;
      
      private var var_832:LagWarningLogger = null;
      
      private var var_833:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_832 = new LagWarningLogger();
         var_1207 = new Array(const_770);
         var _loc4_:int = 0;
         while(_loc4_ < const_770)
         {
            var_1207[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1204,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1193,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_666,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_829,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_645:
               trackLoginStep(HabboLoginTrackingStep.const_1300,String(_communication.port));
               break;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_150)
         {
            Component(var_150).events.addEventListener(HabboConfigurationEvent.const_174,onConfigurationLoaded);
            if(var_230 != null)
            {
               var_230.configuration = var_150;
            }
            if(var_229 != null)
            {
               var_229.configuration = var_150;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_255.events.addEventListener(AdEvent.const_369,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_829,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_666,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_645,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_552,onHotelViewEvent);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_833)
            {
               var_833.release(new IIDHabboWindowManager());
               var_833 = null;
            }
            if(var_255)
            {
            ...
            if(var_169)
            {
               if(true)
               {
                  ...
                  Component(var_169).events.removeEventListener(HabboFriendListTrackingEvent.const_310,onFriendlistTrackingEvent);
               }
            ...
            if(var_157)
            {
               if(true)
               {
                  var_157.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_157.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_157.release(new IIDHabboHelp());
               var_157 = null;
            }
            if(_roomEngine)
            {
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_150)
         {
            if(var_832 != null)
            {
               var_832.configure(var_150);
            }
            Component(var_150).events.removeEventListener(HabboConfigurationEvent.const_174,onConfigurationLoaded);
         }
      }
      ...
      {
         var_157 = param2 as IHabboHelp;
         var_157.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_157.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_986);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_986,onCoreRunning);
         }
      }
      ...
      {
         var_833 = IHabboWindowManager(param2);
         if(var_833)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++var_1462;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1462);
         }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_169).events.addEventListener(HabboFriendListTrackingEvent.const_310,onFriendlistTrackingEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_552)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1275);
         }
         else if(param1.type == HabboHotelViewEvent.const_440)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1167);
         }
