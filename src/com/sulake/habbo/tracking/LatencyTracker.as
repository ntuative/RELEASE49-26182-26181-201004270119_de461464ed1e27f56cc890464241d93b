package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         var_1515 = getTimer();
         var_507.add(var_1262,var_1515);
         _connection.send(new LatencyPingRequestMessageComposer(var_1262));
         ++var_1262;
      }
      ...
      public function init() : void
      {
         ...
         var_1512 = int(var_150.getKey("latencytest.interval"));
         var_1514 = int(var_150.getKey("latencytest.report.index"));
         var_1996 = int(var_150.getKey("latencytest.report.delta"));
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var_152.push(_loc4_);
         if(var_152.length == var_1514 && var_1514 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - var_1513) > var_1996 || var_1513 == 0)
            {
               var_1513 = _loc9_;
