   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_369,0,0,_loc4_,var_1559,var_897,var_898));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2124 = int(_config.getKey("interstitial.interval","30000"));
         var_2125 = int(_config.getKey("interstitial.show.time","5000"));
         var_1561 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1314 = _loc2_.imageUrl;
         var_1559 = _loc2_.clickUrl;
         if(var_1314 != "" && var_1559 != "")
         {
            _loc3_ = var_1314;
            ...
            _loc4_ = new URLRequest(var_1314);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1315 = _loc2_.imageUrl;
         var_2123 = _loc2_.clickUrl;
         var_746 = getTimer();
         if(var_1315 != "")
         {
            _loc3_ = var_1315;
            ...
            if(var_241 == null)
            {
               var_241 = new Timer(var_2125,1);
               var_241.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_241.reset();
            ...
            var_241.start();
            _loc4_ = new URLRequest(var_1315);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_368,0,0,param1.bitmapData,var_2123));
            var_746 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_898 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1561 > 0 && var_1560 >= var_1561)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_746;
         if(_loc1_ > var_2124)
         {
            ++var_1560;
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_417));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_897 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
