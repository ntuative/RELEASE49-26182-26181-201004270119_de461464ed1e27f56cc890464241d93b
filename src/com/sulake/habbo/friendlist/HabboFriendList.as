package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1544:OpenedToWebPopup;
      ...
      private var var_1543:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_607:ISessionDataManager;
      
      private var var_372:FriendRequests;
      
      private var var_2001:int;
      
      var var_88:FriendCategories;
      
      private var var_2086:FriendListLookAndFeel;
      ...
      {
         var_2086 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_88 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1543 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_372.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_372.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_407.findTab(FriendListTab.const_93).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var_607 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_372 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_88.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_88.addCategory(new FriendCategory(FriendCategory.const_999,getText("friendlist.friends")));
         var_88.addCategory(new FriendCategory(FriendCategory.const_466,getText("friendlist.friends.offlinecaption")));
         ...
         method_8();
         registerListeners();
         var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_135,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         if(var_134)
         {
            var_134.release(new IIDHabboMessenger());
            var_134 = null;
         }
         if(var_150)
         {
         ...
         if(var_607)
         {
            var_607.release(new IIDSessionDataManager());
            var_607 = null;
         }
         super.dispose();
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_134 = param2 as IHabboMessenger;
      ...
      private function onAcceptBuddyResult(param1:IMessageEvent) : void
      {
         ...
         for each(_loc3_ in _loc2_.method_9)
         {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1543.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_372.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_607.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_607.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_372.limit)
         {
            var_372.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_407.findTab(FriendListTab.const_93);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_791.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_372.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_407.findTab(FriendListTab.const_93);
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1544 == null)
         {
            var_1544 = new OpenedToWebPopup(this);
         }
         var_1544.show(x,y);
      }
