package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1411:String = "messageinput";
      ...
      private function prepare() : void
      {
         ...
         var_867 = IWindowContainer(var_14.content.findChildByName("main_content"));
         var_270 = IWindowContainer(var_14.content.findChildByName("footer"));
         var_1141.prepare(var_867);
         var_14.procedure = onWindow;
         var_14.content.setParamFlag(HabboWindowParam.const_1000,false);
         var_14.content.setParamFlag(HabboWindowParam.const_1374,true);
         var_14.header.setParamFlag(HabboWindowParam.const_521,false);
         var_14.header.setParamFlag(HabboWindowParam.const_836,true);
         var_14.content.setParamFlag(HabboWindowParam.const_521,false);
         var_14.content.setParamFlag(HabboWindowParam.const_836,true);
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_270.y = Util.getLowestPoint(var_14.content);
         ...
         var_14.scaler.setParamFlag(HabboWindowParam.const_909,this._friendList.tabs.findSelectedTab() != null);
         var_14.scaler.setParamFlag(HabboWindowParam.const_521,false);
         var_14.scaler.setParamFlag(HabboWindowParam.const_1000,false);
         var_14.scaler.x = 0 - var_14.scaler.width;
         var_14.scaler.y = 0 - var_14.scaler.height;
         var_1413 = var_14.height;
         var_1412 = var_14.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc4_:int = var_1412 == -1 ? 0 : int(0 - var_1412);
