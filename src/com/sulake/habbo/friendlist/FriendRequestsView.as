package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1439:String = "no_reqs_info";
       
      
      private var var_1597:IContainerButtonWindow;
      
      private var _friendList:HabboFriendList;
      
      private var var_1596:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_318 && _loc4_.state != FriendRequest.const_340)
            {
      ...
      {
         var_1597 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1596 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1596.procedure = onDismissAllButtonClick;
         var_1597.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1597,_loc1_);
         setEnabled(var_1596,_loc1_);
      }
