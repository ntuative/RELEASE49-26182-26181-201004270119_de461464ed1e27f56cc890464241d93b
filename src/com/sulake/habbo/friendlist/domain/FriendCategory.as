package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_319:int = 100;
      ...
      {
         return Math.ceil(this.var_231.length / const_319);
      }
      ...
      {
         if(this.var_838 >= this.getPageCount())
         {
            this.var_838 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_838 + 1) * const_319,this.var_231.length);
      }
