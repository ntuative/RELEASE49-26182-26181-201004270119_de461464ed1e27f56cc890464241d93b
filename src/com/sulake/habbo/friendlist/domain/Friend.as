package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1551:int = "F".charCodeAt(0);
      
      public static const const_1465:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         var_727 = param1.online;
         var_1254 = param1.followingAllowed && param1.online;
         var_306 = param1.figure;
         var_1252 = param1.motto;
         var_1253 = param1.lastAccess;
         var_1211 = param1.categoryId;
         var_1251 = param1.realName;
