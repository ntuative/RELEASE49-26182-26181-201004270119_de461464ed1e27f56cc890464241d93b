package com.sulake.habbo.communication.encryption
{
   ...
   public class RC4_R27 extends RC4 implements IEncryption
   {
      ...
      private static const const_1043:int = 52;
      ...
      private var var_1727:PseudoRandom;
      
      private var var_1439:IEncryption;
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:ByteArray = CryptoTools.method_3(const_1044);
         var _loc4_:int = 0;
         ...
         super.init(param1);
         var _loc5_:ByteArray = CryptoTools.method_3(PREMIX_STRING);
         var _loc6_:int = 0;
         while(_loc6_ < const_1043)
         {
      ...
      override public function encipher(param1:ByteArray, param2:Boolean = false) : ByteArray
      {
         ...
         if(var_1439 != null)
         {
            ...
            _loc5_ = var_1439.encipher(_loc7_,true);
            ...
            _loc5_.writeBytes(CryptoTools.method_3(_loc4_));
         }
         else
         {
            _loc3_ = super.encipher(param1,true);
            _loc4_ = Base64.encodeBytes(_loc3_,0,false);
            _loc5_ = CryptoTools.method_3(_loc4_);
         }
         return _loc5_;
      }
