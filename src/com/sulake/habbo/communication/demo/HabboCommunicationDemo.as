package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2094:PseudoRandom;
      ...
      private var var_436:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1388:
            case DisconnectReasonEvent.const_1394:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1357:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_1370:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2092)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_730 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_730);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1296,var_2093));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_436.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_436.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2094);
      ...
      {
         var_730 = _habboConfiguration.getKey("sso.ticket",null);
         var_1296 = _habboConfiguration.getKey("flash.client.url","");
         var_2093 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_180 == null)
         {
         ...
         if(var_730 != null)
         {
            var_64.mode = HabboConnectionType.const_423;
            var_64.initConnection(HabboConnectionType.const_274);
         }
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_645);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2094 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_64.mode)
         {
            case HabboConnectionType.const_423:
               _loc6_ = "";
               ...
               var_1070 = _loc4_;
               var_180.loadBannerImage(_loc7_ + "?token=" + var_1070,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_818:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1176:
               var_611 = generateRandomHexString(30);
               var_436 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_436.init(var_611);
               _loc8_ = var_436.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1070);
         ...
         var_436 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_436.init(_loc14_);
            _loc15_ = var_436.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_64.mode = HabboConnectionType.const_818;
            }
         }
         var_64.initConnection(HabboConnectionType.const_274);
      }
