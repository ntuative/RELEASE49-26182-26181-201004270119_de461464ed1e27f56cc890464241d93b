package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_182,onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_717,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_866,onHideWindowEvent);
         var_33 = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_90));
      }
