package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_787:int = 50;
      
      private static const const_1103:Number = 25;
      
      private static const const_1102:int = 50;
      
      private static const const_192:Boolean = true;
       
      
      private var var_614:Timer;
      
      private var var_1076:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1076 = param2;
         var_614 = new Timer(const_1103);
         var_614.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_528.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_528.splice(_loc3_,1);
            var_527.splice(_loc3_,1);
         }
         var_527.push(param1.name);
         var_528.push(param2);
         param1.addEventListener(WindowEvent.const_451,windowEventListener);
         param1.addEventListener(WindowEvent.const_213,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_528[var_527.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1076.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1076.getIconLoc(param1.iconId);
      ...
      {
         return var_527[var_528.indexOf(param1)];
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_613[_loc3_] = new Array();
            }
            if(var_613[_loc3_].indexOf(param1) < 0)
            {
               var_613[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_787 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_787 || param1.desktop.height - param1.y < const_1102;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_527.length)
         {
            if(var_527[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_613[_loc3_].length)
                  {
                     repositionWindow(var_613[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
