package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_863:IgnoredUsersManager;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_709 = [];
         var_1517 = new UserTagManager(events);
         var_1040 = new HabboGroupInfoManager(this,events);
         var_863 = new IgnoredUsersManager(this);
      ...
      private function onProductsReady(param1:Event = null) : void
      {
         ...
         var_1041 = new FurnitureDataParser(_loc2_,var_588,var_502,var_424,_localization);
         var_1041.addEventListener(FurnitureDataParser.READY,onFurnitureReady);
      }
      
      public function getUserTags(param1:int) : Array
      {
         return var_1517.getTags(param1);
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         ...
         var _loc3_:String = var_150.getKey("external.hash");
         _loc2_ = _loc2_.replace("%hash%",_loc3_);
         var_1039 = new ProductDataParser(_loc2_,var_793);
      ...
      {
         return var_1264.getBadgeImage(param1,BadgeImageManager.const_857);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         _id = _loc3_.id;
         _name = _loc3_.name;
         var_1983 = _loc3_.respectTotal;
         var_864 = _loc3_.respectLeft;
         var_509 = _loc3_.petRespectLeft;
         var_306 = _loc3_.figure;
         var_560 = _loc3_.sex;
         var_1251 = _loc3_.realName;
         var_863.initIgnoreList();
      }
      ...
      public function getFloorItemDataByName(param1:String) : IFurnitureData
      {
         ...
         return getFloorItemData(parseInt(var_424.getValue(param1)));
      }
      ...
      {
         return var_863.isIgnored(param1);
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         var_2005 = _loc2_.isOpen;
         var_2004 = _loc2_.onShutDown;
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            var_306 = _loc2_.figure;
            var_560 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(_id,var_306,var_560));
         }
      }
      ...
      public function hasUserRight(param1:String) : Boolean
      {
         ...
         return var_709.indexOf(param1) >= 0;
      }
      ...
      public function getWallItemDataByName(param1:String) : IFurnitureData
      {
         ...
         return getWallItemData(parseInt(var_424.getValue(param1)));
      }
      
      public function ignoreUser(param1:String) : void
      {
         var_863.ignoreUser(param1);
      }
      
      private function onUserRights(param1:IMessageEvent) : void
      {
         var _loc2_:UserRightsMessageEvent = param1 as UserRightsMessageEvent;
         var_709 = _loc2_.rights;
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_1517.communication = _communication;
         var_1040.communication = _communication;
         var_863.registerMessageEvents();
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return var_588.getValue(param1.toString());
      }
      ...
      public function get isAnyRoomController() : Boolean
      {
         ...
         return var_709.indexOf("fuse_any_room_controller") >= 0;
      }
      ...
      public function getWallItemData(param1:int) : IFurnitureData
      {
         ...
         return var_502.getValue(param1.toString());
      }
      ...
      private function initBadgeImageManager() : void
      {
         ...
         var_1264 = new BadgeImageManager(_loc1_,events,var_150,_localization);
      }
