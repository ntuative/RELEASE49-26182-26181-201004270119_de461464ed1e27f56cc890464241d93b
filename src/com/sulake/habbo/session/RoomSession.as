package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1024:UserDataManager;
      ...
      public function start() : Boolean
      {
         ...
         {
            var_33 = RoomSessionEvent.const_100;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1024 as IUserDataManager;
      }
