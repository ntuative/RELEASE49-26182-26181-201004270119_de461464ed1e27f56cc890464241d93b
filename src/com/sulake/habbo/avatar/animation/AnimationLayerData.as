package com.sulake.habbo.avatar.animation
{
   ...
   public class AnimationLayerData implements IAnimationLayerData
   {
      ...
      public static const const_384:String = "fx";
      ...
      private var var_1532:IActiveActionData;
      ...
      public function AnimationLayerData(param1:AvatarStructure, param2:XML, param3:String, param4:int, param5:IActionDefinition)
      {
         ...
         var_1322 = parseInt(param2.@dy);
         var_1323 = parseInt(param2.@dz);
         var_1259 = parseInt(param2.@dd);
         _type = param3;
         ...
         if(param5 != null)
         {
            var_1532 = new ActiveActionData(param5.state,_loc7_);
            var_1532.definition = param5;
         }
      }
