package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1417,var_1418,var_1416,_alphaMultiplier);
         var_968 = generatePaletteMapForGrayscale(var_1675,var_1676);
      }
      
      public function get reds() : Array
      {
         return var_968.getValue("reds") as Array;
      }
      ...
      {
         return var_968.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_968.getValue("greens") as Array;
      }
      ...
      {
         return var_968.getValue("alphas") as Array;
      }
