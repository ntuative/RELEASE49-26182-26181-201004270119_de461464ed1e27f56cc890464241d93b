package com.sulake.habbo.avatar.structure
{
   ...
   public class FigureData implements IStructureData, IFigureData
   {
      ...
      public function method_1(param1:XML) : Boolean
      {
         ...
         {
            var_684[String(_loc3_.@type)] = new SetType(_loc3_);
         }
         return true;
      }
      ...
      {
         var _loc3_:SetType = var_684[param1] as SetType;
         if(_loc3_)
         {
      ...
      public function appendXML(param1:XML) : Boolean
      {
         ...
         for each(_loc3_ in param1.sets.settype)
         {
            _loc5_ = var_684[String(_loc3_.@type)];
            if(_loc5_ == null)
            {
               var_684[String(_loc3_.@type)] = new SetType(_loc3_);
            }
