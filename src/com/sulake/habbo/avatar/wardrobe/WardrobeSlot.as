package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit
   {
      ...
      public function updateView() : void
      {
         ...
         if(var_306 && var_1146)
         {
            _loc5_ = var_48.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.SMALL,var_560);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_41,parseInt(FigureData.const_718));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               var_306 = var_48.figureData.getFigureString();
               var_560 = var_48.gender;
               var_48.handler.saveWardrobeOutfit(var_1415,this);
               updateView();
               break;
            case "get_button":
               if(var_306)
               {
                  var_48.loadAvatarInEditor(var_306,var_560,var_48.clubMemberLevel);
               }
         }
      }
   }
