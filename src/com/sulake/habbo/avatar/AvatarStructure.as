package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_409:PartSetsData;
      
      private var var_1876:PartOffsetData;
      
      private var var_839:AvatarActionManager;
      
      private var var_170:IAssetLibrary;
      
      private var var_1010:IAssetLibrary;
      
      private var var_1877:AvatarRenderManager;
      ...
      private var var_1487:AvatarStructureDownloadSet;
      
      private var var_1219:Array;
      
      private var var_697:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_409 = new PartSetsData();
         _animationData = new AnimationData();
         var_1487 = new AvatarStructureDownloadSet();
         var_697 = new AnimationManager();
         var_698 = param4;
         var_1876 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_839.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_839.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_302.appendXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_839.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_697.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_409.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_409.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1177[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_839.getDefaultActionType();
         var _loc9_:Array = var_409.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_697.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        if(_loc14_.indexOf(_loc28_.type) > -1)
                        {
                           ...
                           _loc13_ = var_409.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_409.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      private function onStructureReady(param1:Event = null) : void
      {
         ...
         {
            var_409.getPartDefinition("ri").appendToFigure = true;
            var_409.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_698)
         {
            case AvatarType.const_83:
               ...
               var_1487.add(new AvatarStructureDownload(var_170,_loc5_,var_302));
               break;
            case AvatarType.PET:
         }
         var_1487.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_697.getAnimation(param1);
      }
      ...
      {
         var_839 = new AvatarActionManager(var_170,var_698);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1219 = var_302.getMandatorySetTypeIds();
         return var_1219;
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_1010.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_1010.getAssetByName("dance" + _loc1_).content as XML;
            var_697.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_1010.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_1010.getAssetByName("fx" + _loc1_).content as XML;
            var_697.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_839.sortActions(param1);
      }
   }
}
