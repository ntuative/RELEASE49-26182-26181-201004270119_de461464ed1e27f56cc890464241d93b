package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1623:String = "hot_looks";
      ...
      public function HotLooksModel(param1:HabboAvatarEditor)
      {
         ...
         var_447["null"] = new Array();
         var_447["null"] = new Array();
         var_447["undefined.index"] = 0;
         var_447["undefined.index"] = 0;
         requestHotLooks();
      }
      ...
      {
         var _loc1_:String = var_48.configuration.getKey("avatareditor.promohabbos");
         var _loc2_:URLRequest = new URLRequest(_loc1_);
         var _loc3_:AssetLoaderStruct = var_48.assets.loadAssetFromFile("hotLooksConfiguration",_loc2_,"text/xml");
         _loc3_.addEventListener(AssetLoaderEvent.const_37,onHotLooksConfiguration);
      }
      
      public function selectHotLook(param1:int) : void
      {
         var _loc2_:Array = var_447["null"];
         ...
         if(_loc3_ != null)
         {
            ...
            var_48.loadAvatarInEditor(_loc3_.figure,_loc3_.gender,var_48.clubMemberLevel);
         }
      }
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         var _loc3_:XmlAsset = var_48.assets.getAssetByName("hotLooksConfiguration") as XmlAsset;
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.content as XML;
            for each(_loc5_ in _loc4_.habbo)
            {
               _loc6_ = new Outfit(var_48,_loc5_.@figure,_loc5_.@gender);
               (var_447[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
