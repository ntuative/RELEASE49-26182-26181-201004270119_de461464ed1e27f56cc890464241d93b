package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_694:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_694.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_165)
         {
            ...
            var_88 = new Map();
            var_406 = new Map();
            var_88.add(AvatarEditorFigureCategory.const_988,new BodyModel(this));
            var_88.add(AvatarEditorFigureCategory.const_50,new HeadModel(this));
            var_88.add(AvatarEditorFigureCategory.const_341,new TorsoModel(this));
            var_88.add(AvatarEditorFigureCategory.const_1173,new LegsModel(this));
            var_88.add(AvatarEditorFigureCategory.const_1237,new HotLooksModel(this));
            var_406.add(AvatarEditorSideCategory.WARDROBE,new WardrobeModel(this));
            var_406.add(AvatarEditorSideCategory.const_449,new ClubPromoModel(this));
            var_165 = true;
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1004 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1476;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1004 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1060)
                  {
                     _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1612.clone() as IWindowContainer,param1,_loc14_);
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1160)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_1004 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1383.clone() as IWindowContainer,param1,_loc6_,_loc12_,_loc15_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_406.getValue(AvatarEditorSideCategory.WARDROBE);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_694.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_406.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(_windowContext == null)
            {
               _windowContext = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_61,HabboWindowStyle.const_43,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorFigureCategory.const_988);
         return true;
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_694 = _avatarRenderManager.getFigureData(AvatarType.const_83);
      }
