package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_1018:BitmapData;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            var_1018 = _loc4_.content as BitmapData;
         }
         if(_window != null)
         {
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_341 && var_1018)
         {
            ...
            var_341.bitmap.copyPixels(var_1018,var_1018.rect,new Point(0,0 - 0 - 8));
            var_341.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}
