package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1071:String = AvatarSetType.const_41;
      
      private static const const_1070:String = "Default";
      
      private static const const_1072:int = 125;
       
      
      private var var_1257:int = 0;
      
      private var var_306:AvatarFigureContainer;
      ...
      private var var_505:IAvatarDataContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String, param6:String = null)
      {
         ...
         if(var_197 == null)
         {
            var_197 = AvatarScaleType.const_56;
         }
         ...
         var_306 = new AvatarFigureContainer(param3);
         if(param6)
         {
            ...
            if(_loc7_)
            {
               ...
               {
                  if(!var_306.hasPartType(_loc9_))
                  {
                     _loc10_ = var_54.getDefaultPartSet(_loc9_,param6);
                     if(_loc10_)
                     {
                        var_306.updatePart(_loc9_,_loc10_.id,[0]);
                     }
                  }
                  else
                  {
                     _loc11_ = _loc8_.getSetType(_loc9_);
                     _loc12_ = _loc11_.getPartSet(var_306.getPartSetId(_loc9_));
                     if(!_loc12_)
                     {
                        _loc13_ = var_54.getDefaultPartSet(_loc9_,param6);
                        var_306.updatePart(_loc9_,_loc13_.id,[0]);
                     }
                  }
               }
            }
         ...
         {
            _loc14_ = var_306.getPartSetId("pbd");
            solvePetAvatarTypeAndBreed(_loc14_);
            var_1257 = var_1030;
         }
         var_126 = new AvatarImageCache(var_54,this,_assets,var_197);
         setDirection(const_1071,const_1069);
         var_198 = new Array();
         resetActions();
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         {
            param2 = AvatarDirectionAngle.const_643 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_643)
         {
            param2 -= NaN;
         }
         if(var_698 == AvatarType.PET && param1 == AvatarSetType.const_50)
         {
            if((var_93 == 6 || var_93 == 0) && param2 == 7)
            {
               param2 = var_93;
            }
            _loc3_ = var_54.renderManager.petDataManager.getPetData(var_1257);
            if(_loc3_ != null)
            {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         var_418 = false;
         var _loc1_:Array = var_54.sortActions(var_198);
         if(_loc1_ == null)
         {
            var_585 = new Array(0,0,0);
         }
         else
         {
            var_585 = var_54.getCanvasOffsets(_loc1_,var_197,var_93);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  var_171 = var_171.concat(_loc3_.spriteData);
                  if(_loc3_.hasDirectionData())
                  {
                     var_1259 = _loc3_.directionData.offset;
                  }
                  if(_loc3_.hasAvatarData())
                  {
                     var_505 = _loc3_.avatarData;
                  }
               }
            }
            if(_loc2_.actionType == AvatarAction.const_589)
            {
               var_418 = true;
            }
      ...
      {
         return var_54.getPartColor(var_306,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_54.getCanvas(var_197,var_174.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_54.getBodyParts(param1,var_174.definition,var_93);
         var _loc7_:int = _loc5_.length - 1;
         while(_loc7_ >= 0)
         {
            _loc9_ = _loc5_[_loc7_];
            _loc10_ = _loc2_.getImageContainer(_loc9_,var_504);
            if(_loc10_ != null)
            {
               ...
               if(var_698 == AvatarType.PET)
               {
                  ...
                  _loc17_ = var_54.getParts(_loc9_,var_306,_loc15_,"pet",_loc14_.getDirection(),[]);
                  _loc18_ = 32;
                  if(var_197 == AvatarScaleType.SMALL)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     _loc19_ = _loc17_[0];
                     _loc20_ = _loc19_.getFrameIndex(var_504);
                     _loc21_ = var_93;
                     _loc22_ = 1;
                     switch(var_93)
                     {
                     ...
                     _loc23_ = var_54.getPartActionOffset(getSubType(),var_197,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = var_54.getCanvas(var_197,var_174.definition.geometryType);
         if(_image == null || _loc4_ != null && (_image.width != _loc4_.width || _image.height != _loc4_.height))
         {
            _loc4_ = var_54.getCanvas(var_197,var_174.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,var_504);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               if(var_698 == AvatarType.PET)
               {
                  ...
                  _loc15_ = var_54.getParts(_loc8_,var_306,_loc13_,"pet",_loc12_.getDirection(),[]);
                  _loc16_ = var_1257 < 3;
                  ...
                  {
                     _loc18_ = _loc15_[0];
                     _loc19_ = _loc18_.getFrameIndex(var_504);
                     _loc20_ = var_93;
                     _loc21_ = 1;
                     switch(var_93)
                     {
                     ...
                     _loc22_ = var_54.getPartActionOffset(getSubType(),var_197,_loc8_,_loc14_,_loc19_,_loc20_);
                     if(_loc22_ != null)
                     {
         ...
         if(var_505 != null)
         {
            if(false)
            {
               ...
               _image = _loc23_;
               _image.paletteMap(_image,_image.rect,new Point(0,0),var_505.reds,[],[]);
            }
            else
            {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_174 = new ActiveActionData(AvatarAction.const_953);
         var_174.definition = var_54.getActionDefinition(const_1070);
      ...
      {
         return var_54.getBodyPartData(param1.animation.id,var_504,param1.id);
      }
            ...
            case AvatarAction.const_599:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1384:
                     if(var_698 == AvatarType.const_83)
                     {
                        if(var_93 == 0)
                        {
