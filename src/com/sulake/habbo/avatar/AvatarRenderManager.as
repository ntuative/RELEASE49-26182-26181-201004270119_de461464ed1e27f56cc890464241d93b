package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_666:PetDataManager;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_83:
               _loc3_ = var_220.getValue(AvatarType.const_83) as AvatarStructure;
               break;
            case AvatarType.PET:
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_220.getValue(AvatarType.const_83) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      private function init() : void
      {
         ...
         var_220.add(AvatarType.const_83,_loc5_);
      ...
      {
         return var_666 as IPetDataManager;
      }
      
      public function set mode(param1:String) : void
      {
         var_688 = param1;
         if(var_688 == RenderMode.const_1312)
         {
            init();
         }
         if(var_688 == RenderMode.const_1249)
         {
            init();
      ...
      {
         var _loc5_:String = var_666.createAvatarFigureString(param1,param2,param3);
      ...
      {
         var _loc4_:AvatarStructure = var_220.getValue(AvatarType.const_83) as AvatarStructure;
         if(_loc4_ == null)
         {
            return null;
         }
