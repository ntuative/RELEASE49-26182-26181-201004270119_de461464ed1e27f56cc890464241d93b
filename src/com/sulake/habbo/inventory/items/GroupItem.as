package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_1570:Number;
      
      protected var _type:int;
      
      protected var _roomEngine:IRoomEngine;
      
      protected var var_2286:BitmapData;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1570));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1386);
         }
         if(_loc1_.id > 0)
         {
