package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_45.updateItemList(var_1188);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_45.alertPopup(TradingView.const_800);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               var_484 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               var_45.alertPopup(TradingView.const_1006);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_33 + " NEW STATE: " + param1 + " OWN: " + var_484 + " OTHER: " + var_679);
         ...
         {
            case const_169:
               if(param1 == const_185 || param1 == const_229)
               {
                  var_33 = param1;
                  _loc2_ = true;
               }
      ...
      public function close() : void
      {
         if(var_620)
         {
            if(var_33 != const_169 && var_33 != const_229)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_169;
            var_11.toggleInventorySubPage(InventorySubCategory.const_962);
            var_620 = false;
         }
         var_45.setMinimized(false);
      }
