package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1017:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_578 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_578.width;
         var_92 = var_578.height;
         var_1016 = param5;
         var_844 = param6;
         var_233 = Math.floor(var_1016 / _thumbWidth);
         var_19 = new BitmapData(var_1016,var_844);
      }
      
      public function resolveIndexFromImageLocation(param1:Point) : int
      {
         var _loc2_:Point = resolveGridLocationFromImage(param1);
         return int(_loc2_.y * var_233 + _loc2_.x);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = var_233 - param1.x - 1;
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_578.width,var_578.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_578.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_578,var_578.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1017 != null)
         {
            _loc1_ = var_1017.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_499 = resolveRowCountFromList();
         if(var_499 == 0)
         {
            var_19 = new BitmapData(var_1016,var_844);
            return;
         }
         var_19 = new BitmapData(Math.max(var_233 * _thumbWidth,var_1016),Math.max(var_499 * var_92,var_844),true,16777215);
         var_19.fillRect(var_19.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_499)
         {
            _loc4_ = 0;
            while(_loc4_ < var_233)
            {
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_233 && var_19.height < _loc3_.y * var_92)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_233 - 1),var_92);
         _loc2_.copyPixels(var_19,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_233 - 1),0,_thumbWidth,var_19.height);
         _loc2_.copyPixels(var_19,_loc4_,new Point(0,var_92),null,null,true);
         _loc4_ = new Rectangle(0,var_92,_thumbWidth * (var_233 - 1),0 - var_92);
      ...
      {
         var _loc1_:Array = getList();
         return int(Math.ceil(_loc1_.length / var_233));
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / var_233);
         var _loc3_:int = param1 % var_233;
         return new Point(_loc3_,_loc2_);
      }
