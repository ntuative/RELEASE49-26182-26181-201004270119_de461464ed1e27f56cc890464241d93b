package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function categorySwitch(param1:String) : void
      {
         ...
         {
            var_48.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_PETS));
         }
      }
      ...
      {
         var_48.furniModel.switchCategory(param1);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1277 && param1.type == RoomEngineObjectEvent.const_196)
         {
            var_48.showView();
            var_1277 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         if(var_48.roomSession.isRoomOwner)
         {
            var_1277 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_39,RoomObjectTypeEnum.const_300,_loc3_.figure);
            var_48.closeView();
            return;
         }
         if(!var_48.roomSession.arePetsAllowed)
         {
            return;
         }
         if(!param2)
      ...
      {
         if(var_1044.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
