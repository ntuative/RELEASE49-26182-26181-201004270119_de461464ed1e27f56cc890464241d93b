package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_320:PetsGridItem;
      ...
      private var var_508:IItemGridWindow;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_508 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      private function selectFirst() : void
      {
         ...
         setSelectedGridItem(var_633.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_320 != null)
         {
            var_320.setSelected(false);
         }
         var_320 = param1;
         if(var_320 != null)
         {
            var_320.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_320.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_633.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_508.removeGridItem(_loc2_.window);
         if(var_320 == _loc2_)
         {
            var_320 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_633.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_508.addGridItem(_loc2_.window);
            var_633.add(param1.id,_loc2_);
            if(var_320 == null)
            {
               selectFirst();
            }
