package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsModel implements IInventoryModel
   {
      ...
      public function AchievementsModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IHabboLocalizationManager, param6:ISessionDataManager)
      {
         ...
         var_369 = param6;
         var_369.events.addEventListener(BadgeImageReadyEvent.const_120,onBadgeImageReady);
         var_377 = new Array();
      ...
      public function addAchievement(param1:Achievement, param2:Boolean = true) : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < var_377.length)
         {
            _loc5_ = var_377[_loc4_] as Achievement;
      ...
      public function removeAchievement(param1:String, param2:int) : void
      {
         ...
         _loc4_ = var_377[0] as Achievement;
      ...
      public function categorySwitch(param1:String) : void
      {
         ...
         {
            var_48.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_ACHIEVEMENTS));
         }
      }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_369 != null)
            {
               var_369.events.removeEventListener(BadgeImageReadyEvent.const_120,onBadgeImageReady);
               var_369 = null;
            }
            _disposed = true;
         }
      ...
      public function getAchievements() : Array
      {
         ...
         {
            _loc3_ = var_377[_loc2_] as Achievement;
            _loc1_.push(_loc3_);
            _loc2_++;
         }
         return _loc1_;
