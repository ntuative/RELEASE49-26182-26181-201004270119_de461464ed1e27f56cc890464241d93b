package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_482 = new Timer(const_1052,1);
      ...
      {
         return var_48.getSubCategoryViewId() == InventorySubCategory.const_250;
      }
      ...
      {
         return var_48.canUserOfferToTrade();
      }
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         {
            var_992 = param1.ref;
            if(!var_48.recyclerModel.running)
            {
               requestClose();
            }
            var_813 = true;
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(var_676 == null)
         {
            var_676 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_676.clone() as IWindowContainer;
         return new GroupItem(param1,param2,param3,_loc11_,_roomEngine,_loc9_.clone(),var_48.recyclerModel.running,param4,param5,_loc7_,param6);
      }
      ...
      public function requestSelectedFurniToTrading() : void
      {
         ...
         var _loc3_:TradingModel = var_48.tradingModel;
         if(_loc3_ != null)
         {
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_250:
               ...
               break;
            case InventorySubCategory.const_962:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         var_48.checkCategoryInitilization(InventoryCategory.const_294);
      ...
      public function categorySwitch(param1:String) : void
      {
         if(param1 == InventoryCategory.const_78 && false)
         {
            ...
            {
               case const_45:
                  var_48.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_FURNI));
                  break;
               case const_46:
                  var_48.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_POSTERS));
                  break;
               case const_323:
                  var_48.toggleInventoryPage(InventoryCategory.const_139);
            }
         }
      }
      ...
      public function requestSelectedFurniSelling() : void
      {
         ...
         var _loc3_:MarketplaceModel = var_48.marketplaceModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateLocks() : void
      {
         ...
         var _loc2_:TradingModel = var_48.tradingModel;
         if(_loc2_ != null)
         {
            _loc1_ = _loc1_.concat(_loc2_.getOwnItemIdsInTrade());
         }
         var _loc3_:RecyclerModel = var_48.recyclerModel;
         if(_loc3_ != null)
         {
      ...
      {
         if(var_813 && param1.type == RoomEngineObjectEvent.const_196)
         {
            var_48.showView();
            var_813 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_330 || _loc3_.category == FurniCategory.const_312 || _loc3_.category == FurniCategory.const_291)
         {
            if(param1)
            {
               return false;
      ...
      public function clearFurniList() : void
      {
         ...
         var_397.add(const_46,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
