package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_820:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            ...
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_475,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_108:
               var_820 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_475:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_46.getValue(InventoryCategory.const_638));
      }
      ...
      {
         return PetsModel(var_46.getValue(InventoryCategory.const_139));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1649);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_46.getValue(InventoryCategory.const_324));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_819.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_819.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return var_46.getValue(InventoryCategory.const_294) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_996 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_46.getValue(InventoryCategory.const_278));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_475,roomSessionEventHandler);
         ...
         var_46.add(InventoryCategory.const_294,_loc3_);
         ...
         var_46.add(InventoryCategory.const_324,_loc7_);
         ...
         var_46.add(InventoryCategory.const_139,_loc10_);
