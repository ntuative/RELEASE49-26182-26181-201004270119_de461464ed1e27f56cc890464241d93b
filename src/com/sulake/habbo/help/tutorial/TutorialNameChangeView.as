package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private var var_262:IBorderWindow;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _main.localization.registerParameter("help.tutorial.name.available","name",var_348);
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _main.localization.registerParameter("help.tutorial.name.confirmation","name",var_348);
         }
         if(var_262 == null)
         {
            var_262 = _main.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_262 == null)
            {
               return;
            }
            ...
            _loc2_.addChild(var_262);
            var_262.procedure = confirmationViewEventHandler;
         }
         _window.visible = !param1;
         var_262.visible = param1;
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_828 = new NameSuggestionListRenderer(_main);
