package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_217:String = "TUI_NAME_VIEW";
      
      public static const const_87:String = "TUI_MAIN_VIEW";
      
      public static const const_338:String = "TUI_CLOTHES_VIEW";
      
      public static const const_393:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         _main = param1;
         _main.events.addEventListener(HabboHelpTutorialEvent.const_450,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_422,onTaskDoneEvent);
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         var_1066 = param2;
         var_1067 = param3;
         if(var_38 == null || var_38.id == const_87)
         {
            prepareForTutorial();
            showView(const_87);
         }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(var_38 != null && (var_38.id == const_217 || var_38.id == const_87))
         {
            showView(const_87);
         }
      }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1489;
         _window.width = _loc2_.width + var_1488;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function dispose() : void
      {
         ...
         if(_main)
         {
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_450,onTaskDoneEvent);
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_422,onTaskDoneEvent);
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_450:
               var_1067 = true;
               if(var_38 != null && var_38.id == const_393)
               {
                  showView(const_87);
               }
               break;
            case HabboHelpTutorialEvent.const_422:
               if(var_38 != null && var_38.id == const_338)
               {
                  var_1295 = true;
                  disposeWindow();
               }
      ...
      {
         var_1065 = true;
         if(var_38 != null && (var_38.id == const_338 || var_38.id == const_87))
         {
            showView(const_87);
         }
      }
      ...
      {
         return var_1065 && var_1066 && var_1067;
      }
   }
}
