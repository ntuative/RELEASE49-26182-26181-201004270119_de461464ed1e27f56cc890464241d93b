package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_23.tellUI(HabboHelpViewEnum.const_215,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_23.tellUI(HabboHelpViewEnum.const_255,_loc6_);
      }
      ...
      {
         var_23.showUI(HabboHelpViewEnum.const_321);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_23.showUI(HabboHelpViewEnum.const_414);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_23.showUI(HabboHelpViewEnum.const_508);
         var_23.tellUI(HabboHelpViewEnum.const_508,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         {
            _loc5_ = _loc3_.method_4(_loc4_);
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_292)
            {
         ...
         var_23.tellUI(HabboHelpViewEnum.const_546);
      }
