package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private static var var_1805:uint = 11129827;
      ...
      private var var_828:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_48.localization.registerParameter("help.tutorial.name.available","name",var_348);
      ...
      private function showSelectionView() : void
      {
         if(!var_572)
         {
            var_572 = createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!var_572)
            {
               return;
            }
            _window.content.addChild(var_572);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!var_262)
         {
            var_262 = createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!var_262)
            {
               return;
            }
            _window.content.addChild(var_262);
         }
         _window.caption = var_48.localization.getKey("hotel_merge.name_change.title.confirm");
         var _loc1_:ITextWindow = var_262.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = var_348;
         }
      ...
      public function showMainView() : void
      {
         if(!_window)
         {
            ...
            var_1201 = _window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1110 || param1 == ChangeUserNameResultMessageEvent.var_1109)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_828 = new NameSuggestionListRenderer(var_48);
         var _loc6_:int = var_828.render(param3,_loc5_);
         var _loc7_:int = 0;
