package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1898:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26182-26181-201004270041");
         var_193 = param5;
         var_102 = new Map();
         var_102.add(HabboHelpViewEnum.const_1268,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_146,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_414,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_255,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_215,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_508,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_321,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_685,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_201,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_102.add(HabboHelpViewEnum.const_989,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_546,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1488 = 0 - _loc3_.width;
         var_1489 = _window.height;
      }
      ...
      {
         return var_102.getValue(var_260);
      }
      ...
      {
         var_1899 = param1;
         var _loc2_:IHelpViewController = var_102.getValue(HabboHelpViewEnum.const_146) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_952:
               showUI(HabboHelpViewEnum.const_989);
               break;
            case CallForHelpResultEnum.const_840:
      ...
      private function setBackButtonActiveState(param1:Boolean = false) : void
      {
         ...
         if(true)
         {
            ...
            var_576.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_576[1],var_576[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_576[0],var_576[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1489;
         _window.width = _loc1_.width + var_1488;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_193 != null)
            {
               var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_450));
      }
