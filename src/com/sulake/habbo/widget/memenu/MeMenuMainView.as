      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_1022);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_838));
            ...
            case "badges":
               ...
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_286);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1004));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_631);
               break;
            case "news":
               if(false && false)
               {
