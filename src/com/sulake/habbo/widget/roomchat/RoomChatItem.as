package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_494:int = 6;
      
      private static const const_354:int = 10;
      
      private static const const_1068:Number = 18;
      
      private static const const_1426:Number = 10;
      
      private static const const_1427:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1026,var_1028,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1026,var_705,var_1028,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1249 = param1.chatType;
         var_1026 = param1.userId;
         var_705 = param1.userName;
         var_1028 = param1.userCategory;
         _message = param1.text;
         var_1247 = param1.userX;
         var_195 = param1.userImage;
         var_1027 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(var_195 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_195.height);
         }
         ...
         if(var_195 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_195.width;
               _loc28_.height = var_195.height;
               _loc28_.bitmap = new BitmapData(var_195.width,var_195.height,true,0);
               _loc28_.bitmap.copyPixels(var_195,var_195.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_416 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1027 != 0)
            {
               _loc30_ = uint(var_1027 >> 16 & 255);
               _loc31_ = uint(var_1027 >> 8 & 255);
               _loc32_ = uint(var_1027 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_354;
            }
            else
            {
               _loc19_.text = var_705 + ":";
               _loc19_.y += var_416;
               _loc19_.width = _loc19_.textWidth + const_354;
               _width += _loc19_.textWidth + const_354;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1249 == RoomWidgetChatUpdateEvent.const_242)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_705);
            }
            else if(var_1249 == RoomWidgetChatUpdateEvent.const_277)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_705);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_416;
            _loc20_.width = _loc20_.textWidth + const_494;
            _width += _loc20_.textWidth + const_494;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_354 + _loc20_.textWidth + const_494;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1026,var_1028,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1026,var_1028,_roomId,_roomCategory,param1);
      }
