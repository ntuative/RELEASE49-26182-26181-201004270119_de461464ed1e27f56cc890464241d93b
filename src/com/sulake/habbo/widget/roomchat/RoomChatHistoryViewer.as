package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_42 = param2.createWindow("chatscroller","",HabboWindowType.const_991,HabboWindowStyle.const_42,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_245 > 0 && param2)
         {
            if(var_1371)
            {
               if(Math.abs(param1 - var_245) <= const_848)
               {
                  return;
               }
               var_1371 = false;
            ...
            if(var_323)
            {
               ...
               _loc5_ = (param1 - var_245) / 0;
               _loc3_ = var_376 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - var_245;
               _loc7_ = true;
               _loc8_ = true;
               if(var_42.scrollV < 1 - const_1133 / var_42.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1602)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_323 && !var_1284)
         {
            ...
            var_160.state = RoomChatHistoryPulldown.const_309;
            if(_widget != null)
            {
