package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_494:int = 16;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1104 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2258 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2257 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_766 = new Timer(1000,1);
         var_766.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_926 = new Timer(5000,1);
         var_926.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_61,HabboWindowStyle.const_42,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowEvent.const_118,onInputChanged);
         _window.addEventListener(WindowEvent.const_451,onWindowMoved);
         var_1373 = true;
         var_143 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2256 = _loc2_.width + const_494 + _loc6_.width + const_1138;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1137,_loc8_.width) + const_494);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1104 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_143 = "";
               }
