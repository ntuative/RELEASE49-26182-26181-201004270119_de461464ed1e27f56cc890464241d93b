package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1661:int = 5;
      
      private const const_1660:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1321 != null && var_1321.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_899 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_899 += param1.height + const_1660;
            return fit(param1);
         }
         param1.offset(_offsetX,var_899);
         _offsetX += param1.width + const_1661;
         return true;
      }
