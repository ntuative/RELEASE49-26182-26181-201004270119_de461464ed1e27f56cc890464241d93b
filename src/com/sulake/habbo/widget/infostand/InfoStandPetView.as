package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1635:String = "level";
      
      private var var_105:IItemListWindow;
      
      private const const_1642:String = "energy";
      
      private var var_1147:Map;
      
      private const const_1643:String = "nutrition";
      ...
      private const const_1637:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_168:PetCommandTool;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_234 != null)
         {
            var_105 = var_234.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_105 == null || var_234 == null || var_61 == null)
         {
            return;
         }
         ...
         var_234.height = NaN;
         _window.width = Math.max(var_234.width,var_61.width);
      ...
      private function openTrainView() : void
      {
         if(var_168 == null)
         {
            var_168 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1147.getValue(var_574) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_168.showWindow(true);
            var_168.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1635,param1.level,param1.levelMax);
         updateStateElement(const_1636,param1.experience,param1.experienceMax);
         updateStateElement(const_1642,param1.energy,param1.energyMax);
         updateStateElement(const_1643,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_574 = param1.id;
         var_1147.remove(param1.id);
         var_1147.add(param1.id,param1);
         if(var_168 && var_168.isVisible() && param1.isOwnPet)
         {
            var_168.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_168.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_168 && var_168.getPetId() == var_574)
               {
                  var_168.showWindow(false);
               }
               break;
            case "btn_train":
               openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_485,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1640,const_1637,false);
