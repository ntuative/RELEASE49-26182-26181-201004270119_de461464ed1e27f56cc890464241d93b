package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1057:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_684,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_109,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_684,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_109,onDoorbellHandled);
