package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_757[var_1096] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_316)
         {
            ...
            var_316 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_316.center();
            var_316.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1096;
         if(var_1096 < var_757.length)
         {
            _loc1_ = var_757[var_1096] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_757.length);
                  _loc2_.text = _loc6_;
               }
