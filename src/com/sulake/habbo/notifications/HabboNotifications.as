package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1081:String = "badges";
      
      private static const const_1086:String = "pet_inventory";
      
      private static const const_1083:String = "pixelbalance";
      
      private static const const_1088:String = "credits";
      
      private static const const_1087:String = "inventory";
      
      private static const const_1082:String = "friendlist";
      
      private static const const_1084:String = "selectfurni";
      
      private static const const_1085:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_593:ParkBusDialogManager;
      ...
      private var var_430:HabboNotificationViewManager;
      
      private var var_719:ClubEndingNotification;
      ...
      private var var_720:ClubGiftNotification;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1390);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_720 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2036)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_995);
            var_2036 = true;
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1086:
               if(var_11)
               {
                  var_11.toggleInventoryPage(InventoryCategory.const_139);
               }
               break;
            case const_1084:
               break;
      ...
      {
         if(param1 != null && this.var_430 != null)
         {
            var_430.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_995,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc5_:BitmapData = _loc4_.getCroppedImage(AvatarSetType.const_50);
         _loc4_.dispose();
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1009,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_168 || param2.type == WindowEvent.const_676)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_430.isSpaceAvailable() && false)
         {
            var_430.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_593 == null)
         {
            var_593 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_593 != null)
         {
            var_593.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1050.splice(0,1);
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1182,_loc5_);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1297)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_719 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_594.events.addEventListener(HabboToolbarEvent.const_90,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_369.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_817);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_817);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_90)
         {
            ...
            var_430 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_875["styles"],var_875["view"],var_594);
            ...
            registerUpdateReceiver(var_430,1);
            registerUpdateReceiver(this,2);
            var_369.events.addEventListener(BadgeImageReadyEvent.const_120,onBadgeImage);
