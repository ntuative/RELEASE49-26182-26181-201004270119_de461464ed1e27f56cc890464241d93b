package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_817:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_483 = new Timer(100);
         var_483.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_39 = new Array();
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,104,"a"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,94,"b"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,36,"c"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,84,"d"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,80,"e"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,80,"f"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,416,"i"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,320,"j"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,448,"k"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,352,"l"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,384,"m"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,372,"n"));
      ...
      private function prepare() : void
      {
         ...
         var_993 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_483)
         {
            var_483.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_483.reset();
            var_483 = null;
         }
      }
      ...
      {
         var_993.goBackToInitialState();
         var_993.input.textBackgroundColor = 4294967295;
         var_817 = var_39[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_61,HabboWindowStyle.const_43,HabboWindowParam.const_75,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_993.getText();
      ...
      {
         var _loc1_:Boolean = var_993.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_817.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1187 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1187 = true;
            _loc3_.y = 1;
