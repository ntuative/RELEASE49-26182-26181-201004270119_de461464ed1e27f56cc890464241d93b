package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1605:CutToHeight = new CutToHeight();
      
      private static var var_1606:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1606.beforeSearch(param2,param1,param3);
         binarySearch(var_1606,param2.length - 1);
      }
   }
}
