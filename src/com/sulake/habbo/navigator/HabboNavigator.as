package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2402:Dictionary;
      ...
      private var var_2010:RoomThumbnailRenderer;
      
      private var var_193:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_628:RoomInfoViewCtrl;
      ...
      private var var_1088:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_628 = new RoomInfoViewCtrl(this);
         var_918 = new RoomCreateViewCtrl(this);
         var_2010 = new RoomThumbnailRenderer(this);
         var_1088 = new GuestRoomPasswordInput(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_277.startSearch(Tabs.const_197,Tabs.const_317,param1);
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_193 != null)
         {
            var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_135,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_135,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_277.startSearch(Tabs.const_241,Tabs.const_224);
         var_407.getTab(Tabs.const_241).tabPageDecorator.tabSelected();
      }
