   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(false)
         {
            ...
            if(_loc6_ != null)
            {
               _loc6_.setDirection(AvatarSetType.const_50,3);
               _loc2_ = _loc6_.getCroppedImage(AvatarSetType.const_50);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_193 + " " + _loc7_);
            if(var_193 != null && _loc7_ != null)
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_928,HabboToolbarIconEnum.MEMENU);
               _loc9_.bitmapData = _loc7_;
               var_193.events.dispatchEvent(_loc9_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_710,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_478,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_710,onFigureUpdate);
         ...
         if(var_11 != null)
         {
            ...
            (var_11 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_980,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_478,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_478:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_411));
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetSelectEffectMessage.const_538);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_673);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_691);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_626);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_709);
         _loc1_.push(RoomWidgetStopEffectMessage.const_693);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1203);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_892);
         _loc1_.push(RoomWidgetToolbarMessage.const_549);
         _loc1_.push(RoomWidgetToolbarMessage.const_744);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_571);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1166);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_968);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_583);
         ...
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_507);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_655);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_524));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetGetEffectsMessage.const_664:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_538:
               if(var_11 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_673:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_709:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1004)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_225,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_626:
               ...
               if(var_11 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_959:
                        _catalog.openCatalogPage(CatalogPageName.const_1356,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_871:
                        var_11.toggleInventoryPage(InventoryCategory.const_278);
                        break;
            ...
            case RoomWidgetStopEffectMessage.const_693:
            ...
            case RoomWidgetNavigateToRoomMessage.const_892:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_583:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_549:
               ...
               if(var_193)
               {
                  var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_11 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_744:
               ...
               if(var_193 && false)
               {
                  var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_453,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_571:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_422));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_581:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_507:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_322,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_655:
