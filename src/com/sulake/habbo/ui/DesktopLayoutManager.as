package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1039:String = "room_view";
      
      private var var_51:IWindowContainer;
      
      private var var_662:int = 50;
      
      private var var_2304:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_51.getChildByTag(const_1039) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_51.findChildByTag(const_1039) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_662;
               _loc2_.width = var_51.desktop.width - var_662;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_662;
               _loc2_.height = var_51.desktop.height - var_662;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_51.desktop.width;
