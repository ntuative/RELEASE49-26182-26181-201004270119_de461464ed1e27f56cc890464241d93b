package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               ...
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_140,onPetInfo);
         ...
         if(false)
         {
            ...
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_140,onPetInfo);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_570);
               _loc6_.id = param1.id;
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_843);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_831);
            ...
            case RoomObjectCategoryEnum.const_39:
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_811)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_633);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_219)
               {
                  _loc13_.realName = _container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_214)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_730);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1200;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1012;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_927;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1189);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_730);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_716);
         _loc1_.push(RoomWidgetUserActionMessage.const_613);
         _loc1_.push(RoomWidgetUserActionMessage.const_711);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_577);
         _loc1_.push(RoomWidgetFurniActionMessage.const_713);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_598);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_514);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1214);
         _loc1_.push(RoomWidgetPetCommandMessage.const_516);
         _loc1_.push(RoomWidgetPetCommandMessage.const_512);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_404)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_485:
               ...
               break;
            case RoomWidgetUserActionMessage.const_716:
            ...
            case RoomWidgetUserActionMessage.const_613:
               ...
               break;
            case RoomWidgetUserActionMessage.const_711:
            ...
            case RoomWidgetUserActionMessage.const_627:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_577:
            ...
            case RoomWidgetUserActionMessage.const_416:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_598:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_514:
            ...
            case RoomWidgetUserActionMessage.const_735:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_512:
