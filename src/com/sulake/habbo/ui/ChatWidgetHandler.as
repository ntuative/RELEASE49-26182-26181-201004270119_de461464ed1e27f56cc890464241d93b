package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_525:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_524.length)
            {
               _loc2_ = var_524.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_524.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_740.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    ...
                                    default:
                                       ...
                                       if(_loc16_ != null)
                                       {
                                          _loc13_ = _loc16_.getCroppedImage(AvatarSetType.const_50).clone();
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_524.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_740.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_582,RoomWidgetChatSelectAvatarMessage.const_665];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_582:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_148,_container.roomSession,0,"Version 26182-26181-201004270041");
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_894 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_894);
            }
            if(var_525 == null)
            {
               var_523.x = 0;
               var_523.y = 0;
               var_523.z = 0;
               var_525 = _loc4_.getScreenPoint(var_523);
               var_894 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_523.x = 0;
            ...
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_525.x || _loc8_.y != var_525.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_525,_loc5_));
      ...
      {
         return RoomWidgetEnum.const_287;
      }
