package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_106:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_684,_loc2_.userName));
               break;
            case RoomSessionDoorbellEvent.const_109:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_109,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_527];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_527:
      ...
      {
         return [RoomSessionDoorbellEvent.const_106,RoomSessionDoorbellEvent.const_109,RoomSessionDoorbellEvent.const_58];
      }
