package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_825:IHabboHelp = null;
      ...
      private var var_824:IRoomWidgetFactory = null;
      ...
      private var var_2143:uint = 16777215;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         _widgets = new Map();
         var_208 = new Map();
         var_184 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_285,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_399,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_578,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_747 = _roomEngine.loadRoomResources(var_36.roomResources);
            if(false)
            {
               var_1327 = false;
         ...
         if(var_255 != null && true)
         {
            var_1326 = !var_255.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_36.roomId,var_36.roomCategory,var_274[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(var_208 != null)
         {
            ...
            {
               _loc5_ = var_208.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_285,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_399,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_578,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_18 = null;
         var_824 = null;
         ...
         if(var_193 && false)
         {
            ...
            var_193.events.removeEventListener(HabboToolbarEvent.const_62,onHabboToolbarEvent);
         }
         var_193 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_2143);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < var_208.length)
         {
            _loc2_ = var_208.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         var_184.setLayout(param1,_windowManager);
         if(var_193 != null)
         {
            var_184.toolbarSize = var_193.size;
            var_184.toolbarOrientation = var_193.orientation;
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_824.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_184.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc3_ != null)
         {
            ...
            if(!var_208.add(param1,_loc3_))
            {
               _loc3_.dispose();
            }
         }
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,var_184.roomViewRect);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         if(var_184 != null)
         {
            var_184.toolbarOrientation = param1.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_650:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_288,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(var_687 != null && _loc3_ == RoomObjectCategoryEnum.const_39)
               {
                  _loc7_ = var_36.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_292)
                  {
                     var_687.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_539:
               ...
               break;
            case RoomEngineObjectEvent.const_386:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_208.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc20_:* = null;
         var _loc2_:Rectangle = var_184.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_733);
            _loc13_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_604);
            _loc14_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_554);
            _loc15_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_533);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_452:
               ...
               var_183 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_316,WindowStyle.const_295,WindowParam.const_88) as IToolTipWindow;
      ...
      {
         if(var_18 != null && var_36 != null && var_1326 && var_1327)
         {
      ...
      {
         var _loc3_:IWindowContainer = var_184.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
