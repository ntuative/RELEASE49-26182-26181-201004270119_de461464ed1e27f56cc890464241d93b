package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_418:
               ...
               {
                  case RoomSessionQueueEvent.const_997:
                     _loc3_ = "null";
                     break;
               ...
               if(_loc7_.length > 1)
               {
                  ...
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1392) + 1;
                  }
               }
               else
               {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomQueueMessage.const_648:
            ...
            case RoomWidgetRoomQueueMessage.const_654:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_997);
               break;
            case RoomWidgetRoomQueueMessage.const_674:
               if(false)
               {
      ...
      {
         return [RoomSessionQueueEvent.const_418];
      }
