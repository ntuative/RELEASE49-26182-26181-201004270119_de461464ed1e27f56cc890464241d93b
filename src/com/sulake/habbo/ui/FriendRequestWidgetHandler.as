package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_518);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_531);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_657);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_518:
            ...
            case RoomWidgetFriendRequestMessage.const_531:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_657:
