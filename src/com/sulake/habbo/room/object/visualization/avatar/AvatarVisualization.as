package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_672:AvatarVisualizationData = null;
      ...
      {
         var_672 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc9_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_660);
         var _loc10_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_662);
         ...
         var _loc13_:int = param2 - var_1172;
         ...
         var _loc15_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_289);
         if(_loc15_ > 0)
         {
         ...
         var _loc16_:Boolean = var_291 != _loc3_.getUpdateID() || var_215 != param1.scale || var_163 != _loc4_.getUpdateID();
         var _loc17_:Boolean = var_418 || var_479 > 0;
         if(_loc16_ || _loc17_)
         {
            increaseUpdateId();
            --var_479;
            ...
            if(_loc6_ == null)
            {
               ...
               _loc6_ = var_672.getAvatar(_loc7_,param1.scale,_loc42_);
               if(_loc6_ == null)
               {
                  return;
               }
            ...
            _loc21_ = _loc4_.getNumber(RoomObjectVariableEnum.const_344);
            if(isNaN(_loc21_) || _loc4_.getString(RoomObjectVariableEnum.const_253) == "float")
            {
               _loc21_ = _loc20_;
            }
            else
            ...
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_253);
            _loc23_ = _loc4_.getString(RoomObjectVariableEnum.const_511);
            _loc6_.appendAction(AvatarAction.const_599,_loc22_,_loc23_);
            _loc24_ = false;
            if(_loc22_ == "lay")
            {
               _loc43_ = int(_loc23_);
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_394);
            if(_loc25_ > 0 && _loc6_.getScale() == AvatarScaleType.const_56)
            {
               _loc44_ = _loc4_.getNumber(RoomObjectVariableEnum.const_465);
               _loc45_ = 3;
               _loc46_ = param2 - _loc44_;
               if(_loc46_ < _loc45_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_290,AvatarAction.const_1318[_loc25_]);
               }
            }
            _loc26_ = _loc4_.getNumber(RoomObjectVariableEnum.const_1023);
            if(_loc26_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_1001,_loc26_);
            }
            ...
            if(_loc27_ > 0)
            {
               ...
               {
                  _loc6_.appendAction(AvatarAction.const_969,_loc27_);
               }
            }
            _loc28_ = _loc4_.getNumber(RoomObjectVariableEnum.const_633);
            _loc29_ = 0;
            if(_loc28_ > 0)
            {
               ...
               {
                  _loc6_.appendAction(AvatarAction.const_1011,_loc28_);
                  _loc53_ = 1;
                  while(_loc53_ < 10)
                  {
            ...
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_921);
            if(_loc29_ > 0)
            {
               _loc30_ = _loc29_;
            }
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_973,_loc30_);
            }
            if(_loc8_)
            {
               _loc6_.appendAction(AvatarAction.const_459);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_370) > 0;
            if(_loc31_ || _loc12_)
            {
            ...
            if(_loc14_)
            {
               _loc6_.appendAction(AvatarAction.const_432);
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_845);
            if(_loc32_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_681,_loc32_);
            }
            ...
            if(_loc22_ == "mv" || _loc22_ == "std")
            {
               ...
               if(var_477 != null)
               {
                  _loc35_.asset = var_477.content as BitmapData;
            ...
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_841))
            {
               _loc35_.visible = true;
               switch(param1.scale)
               {
                  case 32:
                     var_478 = var_672.getAvatarRendererAsset("user_typing_small_png") as BitmapDataAsset;
                     _loc67_ = 3;
                     _loc68_ = -42;
                     break;
                  case 64:
                     var_478 = var_672.getAvatarRendererAsset("user_typing_png") as BitmapDataAsset;
                     _loc67_ = 14;
                     _loc68_ = -83;
               }
               if(var_478 != null)
            ...
            var_809.push(getTimer() - _loc19_);
            if(false)
            {
               _loc69_ = 0;
               _loc70_ = "[";
               for each(_loc71_ in var_809)
               {
                  _loc69_ += _loc71_;
                  _loc70_ += "," + _loc71_;
               }
