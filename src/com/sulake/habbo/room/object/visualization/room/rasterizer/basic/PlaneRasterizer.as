package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_489:String = "MarketPlaceLogic";
      ...
      private var var_840:IGraphicAssetCollection = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc19_ < _loc7_.length)
               {
                  ...
                  _loc21_ = var_840.getAsset(_loc20_);
                  if(_loc21_ != null)
                  {
                     _loc8_.push(_loc21_);
                  }
      ...
      private function method_5(param1:XML, param2:IGraphicAssetCollection) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc7_:* = null;
      ...
      private function initializeTexturesAndMaterials() : void
      {
         ...
         if(_loc1_.length() > 0)
         {
            method_5(_loc1_[0],assetCollection);
         }
