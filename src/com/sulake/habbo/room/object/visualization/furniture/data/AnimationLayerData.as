package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = var_189[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function getFrame(param1:int) : AnimationFrame
      {
         ...
         if(!var_1421)
         {
            _loc4_ = param1 / var_391;
            param1 %= var_391;
            if(var_1422 > 0 && _loc4_ >= var_1422)
            {
               param1 = var_391 - 1;
               _loc3_ = true;
            }
            ...
            _loc6_ = 0;
            _loc6_ = 0;
            while(_loc6_ < var_189.length)
            {
               _loc2_ = var_189[_loc6_] as AnimationFrameSequenceData;
               if(_loc2_ != null)
               {
         ...
         _loc2_ = var_189[_loc7_] as AnimationFrameSequenceData;
      ...
      public function getFrameFromSequence(param1:int, param2:int, param3:int) : AnimationFrame
      {
         ...
         var _loc4_:AnimationFrameSequenceData = var_189[param1] as AnimationFrameSequenceData;
         if(_loc4_ != null)
         {
