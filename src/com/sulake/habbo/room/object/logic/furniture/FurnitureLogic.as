   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc4_ != null)
         {
            if(_loc2_ != null)
            {
               _loc2_.setString(RoomObjectVariableEnum.const_900,_loc4_.itemData);
            }
            return;
         }
         var_661 = false;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         object.getModelController().setNumber(RoomObjectVariableEnum.const_332,var_969,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_375,var_970,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_651,var_971,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1352,var_1683,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1233,var_1684,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_813,var_1148,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_712,var_238,true);
