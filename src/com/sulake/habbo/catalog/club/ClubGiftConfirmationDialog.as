package com.sulake.habbo.catalog.club
{
   ...
   public class ClubGiftConfirmationDialog
   {
      ...
      {
         if(!param1 || !param2 || !var_48 || !var_75)
         {
            return;
         }
         ...
         {
            case "select_button":
               var_48.confirmSelection(var_75.localizationId);
               break;
      ...
      public function showConfirmation() : void
      {
         ...
         var_75.productContainer.view = _loc2_;
         var_75.productContainer.initProductIcon(var_48.roomEngine);
      }
