package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_2262:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1599,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1736 || param1.furniTypeId != var_1735)
         {
            return;
         }
         var_2262 = param1;
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = var_212.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1479,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_212.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_212.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_395)
            {
               var_212.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1862 = _loc3_.creditsWaiting;
         var_212 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_212.add(_loc4_.offerId,_loc6_);
         }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_194)
         {
            var_194 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
      ...
      {
         requestOffers(var_2261,var_2260,var_1725,var_2259);
      }
