package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1436:uint = 4.294967295E9;
      
      private const const_1435:uint = 4.293848814E9;
      
      private var var_920:int;
      
      private const const_1663:uint = 4.291613146E9;
      ...
      private const const_1662:int = 10;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_244.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1435) : uint(const_1436);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_387,var_75,var_1100);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_244.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(var_632[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_631[var_211]);
         _catalog.purchaseProductAsGift(var_387,var_75,var_1100,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_53:
               ...
               break;
            case WindowKeyboardEvent.const_699:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_632 = _loc1_.boxTypes;
            var_631 = _loc1_.ribbonTypes;
            var_921 = var_1505[0];
            _boxIndex = var_632[0];
            var_211 = var_631[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_244.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_244 == null)
         {
            var_244 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_541 == null)
         {
            var_541 = createWindow("suggestion_list_item") as IWindowContainer;
            var_541.procedure = suggestionsEventHandler;
         }
         if(var_244 == null || var_541 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_244.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_541.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
