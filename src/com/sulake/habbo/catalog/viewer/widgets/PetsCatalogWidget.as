package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_393 >= var_297.length)
         {
            return "";
         }
         var petColor:IPetColor = var_297[var_393] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_563[var_1431] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_393 = param1.index;
         if(var_393 < 0 || var_393 > var_297.length)
         {
            var_393 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_595.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_118,onTextWindowEvent);
         var_595 = new Map();
         ...
         var_797 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_297 = [];
         var_563 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_797);
               if(_loc11_)
               {
                  var_563 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_563.length)
         {
            _loc12_ = var_563[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_797,_loc12_.id),getRaceLocalizationKey(var_797,_loc12_.id)));
            _loc6_++;
         }
         var_595.add(var_797,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_926,onApproveNameResult);
         _loc5_ = var_595.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_595.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_393 >= 0 && var_393 < var_297.length)
         {
            _loc7_ = var_297[var_393] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_563[var_1431] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(var_797,_loc3_.id,_loc2_,AvatarScaleType.const_56);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_290,AvatarAction.const_669);
