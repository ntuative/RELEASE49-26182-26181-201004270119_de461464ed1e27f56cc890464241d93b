package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1227:IScrollbarWindow;
      
      protected var var_1175:XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1209.text = "${" + _loc3_.name + "}";
            var_1210.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1209.text = "${" + _loc2_.localizationId + "}";
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_396:
                  _loc4_ = var_1228.clone();
                  if(var_579 != null)
                  {
                     var_579.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_579,var_1227,var_1175);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_234:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_290,AvatarAction.const_679);
                              _loc13_.appendAction(AvatarAction.const_681,_loc6_.productClassId);
      ...
      {
         var_1209 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         ...
         var_1495 = new Point(var_82.x,var_82.y);
         var_579 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1227 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_579 == null)
         {
         ...
         var_1228 = _loc2_.content as BitmapData;
