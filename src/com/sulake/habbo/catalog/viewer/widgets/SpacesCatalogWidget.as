package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_193:String = "landscape";
      ...
      private var var_1181:String = "MarketPlaceLogic";
      ...
      private var var_1182:String = "1.1";
      ...
      private var var_288:BitmapData = null;
      ...
      private var _floorType:String = "MarketPlaceLogic";
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_289 != null && var_288 != null)
         {
            setRoomImage(var_289,var_288);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_150.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_246 >= 0)
               {
                  _loc9_ = _loc1_.children()[var_246];
                  if(_loc9_ != null)
                  {
                     var_1181 = _loc9_.@id;
                  }
         ...
         for each(_loc1_ in var_150.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[var_286];
               if(_loc13_ != null)
               {
                  var_1182 = _loc13_.@id;
               }
         ...
         switch(param1)
         {
            case const_195:
               ...
               for each(_loc8_ in var_150.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_770 = _loc8_.children().length();
                  }
               }
            ...
            case const_194:
               ...
               if(var_326 >= _activeFloorPatterns.length)
               {
                  var_326 = 0;
               }
               var_287 = 0;
            ...
            case const_193:
               ...
               for each(_loc10_ in var_150.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_771 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1181,var_1182,64,this,"window_romantic_wide");
