package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected var var_320:IGridItem;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_727,activateScrollbar);
            _scrollBar.addEventListener(WindowEvent.const_275,activateScrollbar);
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            if(var_826 >= 0 && var_826 < page.offers.length)
            {
               _loc4_ = page.offers[var_826];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_396)
         {
            ++var_1455;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1455);
         }
      }
