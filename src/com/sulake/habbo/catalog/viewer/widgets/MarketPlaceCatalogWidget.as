   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private function updateList() : void
      {
         ...
         if(!var_519)
         {
            ...
            var_519 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_519)
         {
            return;
         ...
         updateStatusDisplay(const_1433,_loc2_.length);
         if(!var_434)
         {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_595)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_519 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_519.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1434);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_883 >= var_595.length)
            {
               return true;
            }
            addListItem(var_595.getWithIndex(var_883));
            ++var_883;
            _loc1_++;
         }
         return false;
