package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function populateColourGrid() : void
      {
         ...
         var_320 = null;
         for each(_loc1_ in var_1239)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1240) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_703.width,var_703.height,true,0);
               _loc3_.bitmap.copyPixels(var_703,var_703.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_869.width,var_869.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_712.width,var_712.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_712,var_712.rect,new Point(0,0),null,null,true);
