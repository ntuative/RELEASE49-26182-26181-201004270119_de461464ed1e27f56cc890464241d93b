package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1408:String = "ctlg_";
      ...
      private var var_1145:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_812:ICatalogViewer;
      ...
      {
         var _loc2_:String = const_1408 + param1;
      ...
      {
         return _localization.hasLinks(var_790);
      }
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1143) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1145;
            _loc2_.init();
         }
         var_1145.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1145.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_790);
      }
