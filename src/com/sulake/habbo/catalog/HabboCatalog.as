package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_401:ClubBuyController;
      ...
      private var var_400:ICatalogNavigator;
      ...
      private var var_1785:GiftWrappingConfiguration;
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1786 && var_485 != null)
         {
            var_485.playSound(HabboSoundTypesEnum.const_948);
         }
         var_1786 = false;
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_401 == null)
         {
            var_401 = new ClubBuyController(this);
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_100:
               var_1197 = param1.session.isPrivateRoom;
               if(var_81 != null)
               {
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         var _loc3_:* = null;
         param1.dispose();
         if(param2.type == WindowEvent.const_168)
         {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1785 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_400 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else if(param1 is Offer)
         {
            if(var_194 == null)
            {
               var_194 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_194.showOffer(this,param1,param2,param3,_loc7_);
         ...
         {
            var_401.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_135,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_400.buildCatalogIndex(_loc2_);
         if(var_998 != "")
         {
            var_400.openPage(var_998);
            var_998 = "";
         }
         else
         {
            var_400.openFrontPage();
         }
      }
      ...
      {
         if(param1 == null || var_300 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_300.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function updatePurse() : void
      {
         ...
         else
         {
            ...
            _localization.registerParameter(_loc2_,"days",String(var_111.clubDays));
            _localization.registerParameter(_loc2_,"months",String(var_111.clubPeriods));
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_300.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1787 && var_485 != null)
         {
            var_485.playSound(HabboSoundTypesEnum.const_1003);
         }
         var_1787 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_300.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_300.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_300 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_300.habboCatalog = this;
      }
