package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1459:IMessageComposer;
      ...
      public function show() : void
      {
         ...
         var_925 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         _main.connection.send(var_1459);
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_925.clone());
         _loc4_.color = var_1370[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
