package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_975:ICheckBoxWindow;
      ...
      private var var_663:ICheckBoxWindow;
      
      private var var_52:IFrameWindow;
      
      private var var_976:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_573,_data.flatId),var_52,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_445);
         if(param1.flatId != var_445)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_445);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_663.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1377,_loc2_,var_390.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_975.isSelected,var_976.isSelected,var_663.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1326);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1220);
      }
      ...
      public function populate() : void
      {
         ...
         var_794 = IDropMenuWindow(var_52.findChildByName("msgTemplatesSelect"));
         prepareMsgSelect(var_794);
         var_794.procedure = onSelectTemplate;
         var_663 = ICheckBoxWindow(var_52.findChildByName("kick_check"));
         var_975 = ICheckBoxWindow(var_52.findChildByName("lock_check"));
         var_976 = ICheckBoxWindow(var_52.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_445));
         Logger.log("BEGINNING TO SHOW: " + var_445);
      }
   }
}
