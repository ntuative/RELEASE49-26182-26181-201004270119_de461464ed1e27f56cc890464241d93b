package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_987:String = "issue_bundle_open";
      
      public static const const_547:String = "issue_bundle_my";
      ...
      private var var_637:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_144 = new Map();
         var_941 = new Map();
         var_637 = new IssueBrowser(this,var_57.windowManager,var_57.assets);
         var_772 = [];
         var_940 = [];
         var_1108 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1108.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
         ...
         for each(_loc4_ in var_144)
         {
            switch(param1)
            {
               case const_987:
                  ...
                  break;
               case const_547:
                  if(_loc4_.state == IssueMessageData.const_405 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_772 = var_772.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_941.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_941.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1398)
         {
            var_153.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_144)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_941.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_941.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_144)
         {
            ...
            _loc8_ = var_940.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1108.remove(param1);
         var_1108.add(param1,_loc3_);
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_405 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      {
         var _loc2_:* = var_1108.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_637 == null || !var_637.isOpen())
         {
            var_57.soundManager.playSound(HabboSoundTypesEnum.const_890);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_941.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_144.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_405 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
